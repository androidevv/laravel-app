...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Add Custom Code</h5>
        ...
        <div class="card-body">
            ...
            {!! Form::open(['action' => 'admin\CustomCodeController@store' , 'method'=>'post' , 'enctype'=>'multipart/form-data']) !!}
                <div class="row">
                    <div class="col-md-12">
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="offset-md-2 col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" cols="5" class="form-control " name="code" placeholder="Enter code here"></textarea>
                                    </div>
                                </div>
                            </div>
