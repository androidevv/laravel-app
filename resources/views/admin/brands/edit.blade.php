...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['action' => ['admin\BrandsController@update' , $brand->brand_id ] , 'method'=>'POST' , 'enctype'=>'multipart/form-data']) !!}
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="offset-md-2 col-md-8">
                                <div class="form-group">
                                    <label>Name:</label>
                                    <input type="text" class="form-control" name="name" value="{{$brand->name}}" placeholder="enter Name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="offset-md-2 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="prev_file" id="" value="{{$brand->file}}"  class="form-input-styled" data-fouc>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="offset-md-2 col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" cols="5" name="description" class="form-control summernote" placeholder="Enter brand description here">{!! $brand->description !!}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="offset-md-2 col-md-8">
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Is Enabled" name="is_enabled" class="form-control form-control-select2" data-fouc>
                                        <option {{($brand->is_enabled == 1)? 'selected': ''}} value="1">Yes</option>
                                        <option {{($brand->is_enabled == 0)? 'selected': ''}} value="0">No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
