                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="offset-md-2 col-md-8">
                                    <div class="form-group">
                                        <label>Page:</label>
                                        <select data-placeholder="Select Brand" name="page" class="form-control form-control-select2" data-fouc>
                            ...
                            <div class="row">
                                <div class="offset-md-2 col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" cols="5" class="form-control" name="meta_description" placeholder="Enter car meta description here"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="offset-md-2 col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" cols="5" class="form-control summernote" name="article" placeholder="Enter Article here"></textarea>
                                    </div>
                                </div>
                            </div>
