...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['action' => 'admin\BlogsController@store' , 'method'=>'post' , 'enctype'=>'multipart/form-data']) !!}
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="offset-md-2 col-md-8">
                                <div class="form-group">
                                    <label for="meta_description">Blog Content:</label>
                                    <textarea rows="5" cols="5" class="form-control summernote" name="content" placeholder="Enter Blog content here"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="offset-md-2 col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" cols="5" class="form-control summernote1" name="meta_description" placeholder="Enter car meta description here"></textarea>
                                </div>
                            </div>
                        </div>
